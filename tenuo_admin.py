...
refuses to run if an admin key is reachable from its environment.
...
import tenuo_claude as tc  # shared read-only helpers + state/paths
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="tenuo-admin", description=__doc__,
